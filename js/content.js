...
export const LOCATIONS = [
  {
    ...
    cloudLevel: -430, cloudColor: '#f3c69c', cloudCount: 26,
  ...
  },
  {
    ...
    cloudLevel: -560, cloudColor: '#ffffff', cloudCount: 18,
  ...
  },
  {
    ...
    cloudLevel: -380, cloudColor: '#e8e2ea', cloudCount: 34,
  ...
  },
  {
    ...
    cloudLevel: -470, cloudColor: '#ffbf8d', cloudCount: 22,
  ...
  },
  {
    ...
    cloudLevel: -300, cloudColor: '#dfe8ea', cloudCount: 40,
...
export const CHALLENGES = [
  ...
  { id: 'turn',    name: 'Turnaround',    desc: 'Land a 180 and walk 10 m back',  icon: '↺', type: 'turnBack', target: 10,  location: 'summit' },
...
export const TRICKS = [
  ...
  { id: 'turn180',  name: '180 turn',      gesture: 'Turn button',  ready: true,  unlock: 'start' },
